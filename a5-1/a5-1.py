...
class GENACINCO:
    ...
    def input_datos(self):
        ...
        for x in range(len(self.lfsruno), 0, -1):
            ...
            elif x == 19 or x == 15 or x == 14 or x == 10:
    ...
    def programa_principal(self,size_clave):
        ...
        for x in range(1, size_clave):
            a_t = int(self.lfsruno[18]) ^ int(self.lfsruno[14]) ^ int(self.lfsruno[13]) ^ int(self.lfsruno[9])
            b_t = int(self.lfsrdos[13]) ^ int(self.lfsrdos[2])
